  ...
  return (
    <footer className="footer">
      <section className={styles.link}>
        <a href="https://github.com/DelsarteAdam" target="_blank">
          <svg
        ...
        <a href="https://www.instagram.com/adam_delsarte/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            version="1.1"
        ...
        <a
          href="https://www.linkedin.com/in/adam-delsarte-39b16b120/"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
